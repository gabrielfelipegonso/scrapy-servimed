...
from shared.auth import (
    AuthClient,
    AuthError,
)  # precisa expor auth_header(username=..., password=...)
...
class ProductPosterConsumer:
    ...
    def _validate_envelope(msg: Any) -> Tuple[str, str, List[JSONItem]]:
        """
        Valida o envelope e retorna (usuario, senha, produtos_sanitizados).
        Se o envelope estiver incorreto, levanta ValueError com detalhes.
        """
        errs: List[str] = []
